...
2013/14 \\Anforderungsspezifikation} \fancyhead[LE,RO]{Seite \thepage\\\slshape \leftmark\\
\slshape\rightmark}
...
2013/14 \\Anforderungsspezifikation} \fancyhead[LE,RO]{Seite \thepage\\\slshape \leftmark\\~} \fancyfoot{} 
...
\begin{table}
	...
	\begin{tabular}
		{|p{2,5cm}||p{2,8cm}|p{2,8cm}|p{2,8cm}|p{2,8cm}|} \hline \textbf{Name(fiktiv)} & Bert Bib & Arnold Admin & Silke Schüler & Bart Besucher\\
...
\begin{figure}
	...
	\includegraphics[width=1
	\textwidth]{StartseiteLoggedOut.png} \label{pic:Startseite} 
\end{figure}
\begin{table}
	[H] \label{1} 
	\begin{tabular}
...
\begin{figure}
	...
	\includegraphics[width=1
	\textwidth]{LoginAdminBibliothekar.png} \label{pic:LoginAdminBib} 
\end{figure}
\begin{figure}
	[H] \caption{Loginseite für Schüler} 
	\includegraphics[width=1
	\textwidth]{LoginSchueler.png} \label{pic:LoginSchueler} 
\end{figure}
\begin{table}
	[H] \label{2} 
	\begin{tabular}
...
\begin{figure}
	...
	\includegraphics[width=1
	\textwidth]{StartseiteLoggedInSchueler.png} \label{pic:StartSchueler} 
\end{figure}
\begin{table}
	[H] \label{3} 
	\begin{tabular}
...
\begin{figure}
	...
	\includegraphics[width=1
	\textwidth]{StartseiteLoggedInBibliothekar.png} \label{pic:StartBib} 
\end{figure}
\begin{table}
	[H] \label{4} 
	\begin{tabular}
...
\begin{figure}
	...
	\includegraphics[width=1
	\textwidth]{Profil.png} \label{pic:Profil} 
\end{figure}
\begin{table}
	[H] \label{5} 
	\begin{tabular}
...
\begin{figure}
	...
	\includegraphics[width=1
	\textwidth]{VormerkungenSchueler.png} \label{pic:Vormerkungen} 
\end{figure}
\begin{table}
	[H] \label{6} 
	\begin{tabular}
...
\begin{figure}
	...
	\includegraphics[width=1
	\textwidth]{VormerkungenSchueler.png} \label{pic:PubAnzeigen} 
\end{figure}
\begin{table}
	[H] \label{7} 
	\begin{tabular}
...
\begin{figure}
	...
	\includegraphics[width=1
	\textwidth]{PublikationHinzufuegen.png} \label{pic:MedHinzufuegen} 
\end{figure}
\begin{table}
	[H] \label{8} 
	\begin{tabular}
...
\begin{figure}
	...
	\includegraphics[width=1
	\textwidth]{PublikationHinzufuegenFilled.png} \label{pic:MedAendern} 
\end{figure}
\begin{table}
	[H] \label{9} 
	\begin{tabular}
...
\begin{figure}
	...
	\includegraphics[width=1
	\textwidth]{PublikationslisteLoggedInBibliothekar.png} \label{pic:MedLoeschen} 
\end{figure}
\begin{figure}
	[H] \caption{Medium löschen aus Detailansicht} 
	\includegraphics[width=1
	\textwidth]{DetailansichtBuchLoggedInBibliothekar.png} \label{pic:MedLoeschenDetailansicht} 
\end{figure}
\begin{table}
	[H] \label{10} 
	\begin{tabular}
...
\begin{figure}
	...
	\includegraphics[width=1
	\textwidth]{PublikationslisteLoggedInBibliothekar.png} \label{pic:CVS-ImportMed} 
\end{figure}
\begin{table}
	[H] \label{12} 
	\begin{tabular}
...
\begin{figure}
	...
	\includegraphics[width=1
	\textwidth]{StartseiteLoggedInSchueler.png} \label{pic:MedSuche} 
\end{figure}
\begin{table}
	[H] \label{13} 
	\begin{tabular}
...
\begin{figure}
	...
	\includegraphics[width=1
	\textwidth]{DetailansichtBuchLoggedOut.png} \label{pic:DetailansichtMedium} 
\end{figure}
\begin{table}
	[H] \label{14} 
	\begin{tabular}
...
\begin{figure}
	...
	\includegraphics[width=1
	\textwidth]{DetailansichtBuchLoggedInSchueler.png} \label{pic:MedBewerten} 
\end{figure}
\begin{table}
	[htbp] \label{15} 
	\begin{tabular}
...
\begin{figure}
	...
	\includegraphics[width=1\textwidth]{Ausleihe.png}
...
\begin{figure}
	...
	\includegraphics[width=1\textwidth]{Rueckgabe.png} \label{pic:MedRueckgabe} 
\end{figure}
\begin{table}
	[H] \label{17} 
	\begin{tabular}
...
\begin{figure}
	...
	\includegraphics[width=1
	\textwidth]{RezensionEingebenSchueler.png} \label{pic:MedRezension} 
\end{figure}
\begin{table}
	[H] \label{18} 
	\begin{tabular}
...
\begin{figure}
	...
	\includegraphics[width=1
	\textwidth]{DetailansichtBuchLoggedInSchueler.png} \label{pic:MedVormerken} 
\end{figure}
\begin{table}
	[H] \label{19} 
	\begin{tabular}
...
\begin{figure}
	...
	\includegraphics[width=1
	\textwidth]{zuBearbeitendeNachrichtenBibliothekar.png} \label{pic:RezensionenFreischalten} 
\end{figure}
\begin{table}
	[H] \label{20} 
	\begin{tabular}
...
\begin{figure}
	...
	\includegraphics[width=1
	\textwidth]{Leserliste.png} \label{pic:Leserliste} 
\end{figure}
\begin{table}
	[H] \label{21} 
	\begin{tabular}
...
\begin{figure}
	...
	\includegraphics[width=1
	\textwidth]{LeserHinzufuegen.png} \label{pic:LeserHinzufuegen} 
\end{figure}
\begin{table}
	[H] \label{22} 
	\begin{tabular}
...
\begin{figure}
	...
	\includegraphics[width=1
	\textwidth]{LeserHinzufuegenFilled.png} \label{pic:LeserAendern} 
\end{figure}
\begin{table}
	[H] \label{23} 
	\begin{tabular}
...
\begin{figure}
	...
	\includegraphics[width=1
	\textwidth]{Leserliste.png} \label{pic:LeserLoeschen} 
\end{figure}
\begin{figure}
	[H] \caption{Leser löschen aus der Detailansicht} 
	\includegraphics[width=1
	\textwidth]{DetailansichtLeser.png} \label{pic:LeserLoeschenAusDetailans.} 
\end{figure}
\begin{table}
	[H] \label{24} 
	\begin{tabular}
...
\begin{figure}
	...
	\includegraphics[width=1
	\textwidth]{zuBearbeitendeNachrichtenBibliothekar.png} \label{pic:CVS-ImportLeser} 
\end{figure}
\begin{table}
	[H] \label{26} 
	\begin{tabular}
...
\begin{figure}
	...
	\includegraphics[width=1
	\textwidth]{DetailansichtLeser.png} \label{pic:LeserDetailans.} 
\end{figure}
\begin{table}
	[H] \label{28} 
	\begin{tabular}
...
\begin{figure}
	...
	\includegraphics[width=1
	\textwidth]{StartseiteLoggedInBibliothekar.png} \label{pic:LeserSuchen} 
\end{figure}
\begin{table}
	[H] \label{29} 
	\begin{tabular}
...
\begin{figure}
	...
	\includegraphics[width=1
	\textwidth]{Administration.png} \label{pic:Admin} 
\end{figure}
\begin{table}
	[H] \label{30} 
	\begin{tabular}
...
\begin{figure}
	...
	\includegraphics[width=1
	\textwidth]{Bibliothekarsliste.png} \label{pic:Bibs} 
\end{figure}
\begin{table}
	[H] \label{31} 
	\begin{tabular}
...
\begin{figure}
	...
	\includegraphics[width=1
	\textwidth]{DetailansichtBibliothekar.png} \label{pic:BibHinzufuegen} 
\end{figure}
\begin{table}
	[H] \label{32} 
	\begin{tabular}
...
\begin{figure}
	...
	\includegraphics[width=1
	\textwidth]{DetailansichtBibliothekar.png} \label{pic:BibLoeschen} 
\end{figure}
\begin{table}
	[H] \label{33} 
	\begin{tabular}
...
\begin{figure}
	...
	\includegraphics[width=1
	\textwidth]{DetailansichtBibliothekar.png} \label{pic:BibAendern} 
\end{figure}
\begin{table}
	[H] \label{34} 
	\begin{tabular}
...
\begin{figure}
	...
	\includegraphics[width=1
	\textwidth]{Statistiken.png} \label{pic:Statistik} 
\end{figure}
\begin{table}
	[H] \label{35} 
	\begin{tabular}
...
\begin{figure}
	...
	\includegraphics[width=1
	\textwidth]{Mahnungen.png} \label{pic:MahnungslisteDrucken} 
\end{figure}
\begin{table}
	[H] \label{37} 
	\begin{tabular}
...
\begin{figure}
	...
	\includegraphics[width=1
	\textwidth]{StartseiteNachrichtbearbeiten.png} \label{pic:StartseiteBearbeiten} 
\end{figure}
\begin{table}
	[H] \label{39} 
	\begin{tabular}
...
\begin{figure}
	...
	\includegraphics[width=1
	\textwidth]{MahngebuehrenAusleihdauer.png} \label{pic:AbgabeBearbeiten} 
\end{figure}
\begin{table}
	[H] \label{40} 
	\begin{tabular}
