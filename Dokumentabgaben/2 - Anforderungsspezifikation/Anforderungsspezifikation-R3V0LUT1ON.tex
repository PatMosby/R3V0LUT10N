...
Zu Hardware- und Software-Abhängigkeiten geben die Punkte \ref{hardware} (Hardwareschnittstellen) und \ref{software} (Softwareschnittstellen) hinreichend Aufschluss.
...
eindeutig dem entsprechenden Nutzer zugeordnet werden kann. 

\item \textbf{2. Ausleihe:}\\
...
\item \textbf{2. Reservierung/Vormerkung:}\\
...
\item \textbf{2. Bearbeiten/Löschen/Hinzufügen:}\\
