...
public class ReaderHandler extends BusinessObjectHandler<Reader> {
    ...
    /* (non-Javadoc)
     * @see eu.it_r3v.bibjsf.businesslogic.BusinessObjectHandler#export(java.io.OutputStream)
     */
    @Override
    ...
    /**
     * Gibt alle inaktiven Benutzer zurück, die länger als 
     * days Tage nicht online waren.
     * @param days Anzahl der Tage die ein Nutzer nicht online war
     * @return inaktive Nutzer
     */
    public Reader showInactiveReader(int days){
    	return null;
    }
