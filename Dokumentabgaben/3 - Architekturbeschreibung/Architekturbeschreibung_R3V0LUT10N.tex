...
Die Einführung beschreibt den Nutzen dieses Dokuments. Es erläutert Definitonen, Akronyme und Abkkürzungen und listet die benutzten Referenzen auf, sowie eine Übersicht über diese Dokument.
...
Die konzeptionelle Sicht zeigt grob die einzelnen Komponenten und derer Zusammenspiel des zu entwickelnden Systems auf. Dies geschieht auf einer hohen Abstraktionsebene und wird im weiteren Verlauf des Dokuments und den folgenden Sichten konkretisiert und verfeinert.
...
Die Datensicht beschreibt das zugrundeliegende Datenmodel und das Zusammenspiel der einzelnen Daten der Datenbank. Dies wird in Form eines erklärenden Textes und Uml-Diagrammen realisiert.

\item{\textbf{Ausführungssicht}}

Die Ausführungssicht zeigt im Prinzip das System in ''Aktion'', d.h. es zeigt auf welche Prozesse laufen, welche Module hierfür gebraucht werden und wie dieses zusammenspielen.
...
Die GUI richtet sich in erster Linie an Bibliothekare und nimmt alle möglichen Aktionen der Bibliothekare entgegen und schickt diese weiter an die Komponente Model um weiter verarbeitet zu werden. Sie bildet ebenfalls eine eigenständige Komponente.

\item{Android-App}

Die Android-App richtet sich in erster Linie an die Nutzer/Leser. und bietet ihnen grundlegende Funktionen die in der Anforderungsspezifikation erarbeitet wurden.
...
Wir haben ein Hauptpaket \texttt{eu.it\_r3v}, in dem sich weitere Unterpakete befinden. Dies dient der Übersicht indem wir gemeinsame Quellcodedateien bündeln und so logisch zusammenhängende Einheiten erzeugen.
...
Das Paket \texttt{bibclient} beinhaltet die Quellcodedateien für die Android-App. Es besteht aus mehreren Klassen:
\begin{itemize}
\item{AsyncBookTask}
\item{BookAdapter}
\item{MainActivity}
\item{Network}
\item{ShowBookActivity}
\item{ShowUserInfoActivity}
\item{LoginActivity}
\item{ShowImpressumActivity}
\item{ShowLeasedBooksActivity}
