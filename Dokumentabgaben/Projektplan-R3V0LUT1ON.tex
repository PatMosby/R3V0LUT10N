...
%Wir planen uns an keine spezielle Entwicklungsmethode zu halten. Allerdings wird uns das Wasserfallmodell\footnote{\url{http://de.wikipedia.org/wiki/Wasserfallmodell}} als Leitmodell dienen.
