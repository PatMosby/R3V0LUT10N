...
Dieses Dokument ist der Projektplan der Gruppe IT\_R3V0LUT10N im des Softwareprojekts im Wintersemester 2013/2014 an der Universität Bremen. Der Projektplan entspricht der Struktur des Standards ANSI/IEEE Std. 1058.1-1987\footnote{\url{http://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=25325&userType=inst}}.
...
Zu den Mindestanforderungen gehören die Erstellung und Abgabe einer Bibliothekssoftware, eines Serverprogramms mit Datenbankanbindung, eines Administrationszugangs und eines Zugangs für mobile Geräte mit kleinem Display. Wir haben uns entschieden den Zugang für die mobilen Geräte in Form einer Android-App zu realisieren, weil wir dies für Zeitgemäß und einfacher für den Leser, an den diese Form des Zugangs gerichtet ist, halten. Die zu erstellende Bibliothekssoftware dient in erster Linie zur Verwaltung des Medienbestandes der Bibliothek und dem Verleihen dieser Medien durch Bibliothekare an der Oberschule Rockwinkel. Funktionen der Software für Bibliothekare beinhalten Inventarisierung, Ausleihe, Verlängerung, Rückgabe, Erinnerung, Mahnung, Statistiken und die Verwaltung von Lesern. Der Administrationszugang wird benötigt um Bibliothekare anzulegen, zu löschen, deren Stammdaten zu ändern, oder deren Rechte innerhalb der Software zu verändern. Für die Leser werden folgende Funktionen im Web-Browser sowie der Android-App implementiert: Ausleihen von Medien, Suche von und Information über Medien, Vormerkung von Medien, Verlängerung der Ausleihe, Ausleihhistorie, Bewertung und Rezension der Medien.\\ \todo{Weitere Features sind den oben genannten Mindestanforderungen zu entnehmen, oder werden im weiteren Verlauf des Projektplans erläutert.}
...
\item[M6 - 17.11.2013] Abgabe der Anforderungsspezifikation \\
...
\item[M10 - 10.-15.02.2014] Akzeotanztest\\
