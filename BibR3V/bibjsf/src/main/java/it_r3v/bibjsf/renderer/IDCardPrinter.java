...
import it_r3v.bibjsf.utils.Configuration;
...
public class IDCardPrinter extends Printer {
    ...
    /* (non-Javadoc)
     * @see it_r3v.bibjsf.renderer.Printer#printCard(org.apache.pdfbox.pdmodel.PDDocument, org.apache.pdfbox.pdmodel.PDPage, int, int, it_r3v.bibjsf.renderer.Content)
     */
    @Override
