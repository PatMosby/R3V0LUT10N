...
public class IDCardPrinter extends Printer {
    ...
    /* (non-Javadoc)
     * @see eu.it_r3v.bibjsf.renderer.Printer#printCard(org.apache.pdfbox.pdmodel.PDDocument, org.apache.pdfbox.pdmodel.PDPage, int, int, eu.it_r3v.bibjsf.renderer.Content)
     */
    @Override
