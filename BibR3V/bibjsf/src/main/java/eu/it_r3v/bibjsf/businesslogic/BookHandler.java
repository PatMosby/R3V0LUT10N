...
import eu.it_r3v.IllegalRating;
...
public class BookHandler extends BusinessObjectHandler<Book> {
    ...
    /* (non-Javadoc)
     * @see eu.it_r3v.bibjsf.businesslogic.BusinessObjectHandler#add(java.lang.Object)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see eu.it_r3v.bibjsf.businesslogic.BusinessObjectHandler#update(int, java.lang.Object)
     */
    @Override
	...
	/* (non-Javadoc)
	 * @see eu.it_r3v.bibjsf.businesslogic.BusinessHandler#get(int)
	 */
	@Override
    ...
    /* (non-Javadoc)
     * @see eu.it_r3v.bibjsf.businesslogic.BusinessObjectHandler#exportCSV(java.io.OutputStream)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see eu.it_r3v.bibjsf.businesslogic.BusinessObjectHandler#importCSV(java.io.InputStream)
     */
    @Override
	...
	/* (non-Javadoc)
	 * @see eu.it_r3v.bibjsf.businesslogic.BusinessObjectHandler#get(java.util.List, int, int, java.util.List)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see eu.it_r3v.bibjsf.businesslogic.BusinessObjectHandler#getNumber(java.util.List)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see eu.it_r3v.bibjsf.businesslogic.BusinessHandler#getPrototype()
	 */
	@Override
