...
public class AdministrationHandler extends BusinessHandler {
     ...
     * @throws DataSourceException
     */
    public void resetDB() throws DataSourceException {
        persistence.reset();
    }
    ...
    /**
     * Restores the database content using a previous backup
     * if one exists (in which case all current data are lost).
     * If none exists, an exception is thrown.
     *
     * @throws DataSourceException
     */
    public void restoreDB() throws DataSourceException {
        persistence.restore();
    }
